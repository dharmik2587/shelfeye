...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-3xl border border-zinc-800 bg-zinc-900/95 p-6 text-zinc-100 shadow-volumetric backdrop-blur-3xl",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("text-sm text-zinc-300", className)} {...props} />
));
